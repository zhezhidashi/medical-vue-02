	...
	<div style="display: flex">
		...
		>
			...
			>
				...
				>
					<el-button type="primary" style="margin-bottom: 24px"
						>导入用户</el-button
					>
				</el-upload>
			</div>
			...
			<el-table :data="userTable" style="width: 95%" stripe border>
				...
				<el-table-column prop="userType" label="用户类型">
					<template slot-scope="props">
						<el-tag v-if="props.row.userType === 2" type="success"
							>管理员</el-tag
						>
				...
				<el-table-column prop="projects" label="已授权项目">
					<template slot-scope="props">
						<div
							v-for="(item, index) in props.row.projects"
							:key="index"
				...
				<el-table-column label="操作" width="150" align="center">
					<template slot-scope="props">
						<el-button
							@click="changeUser(props.row, props.$index)"
							type="primary"
							size="small"
							>修改</el-button
						>
			...
			>
				...
				>
					...
					<el-form-item prop="projects" label="已授权项目">
						<div
							v-for="item in addUserForm.projects"
							:key="item"
							style="margin-right: 10px"
						>
							{{ projectsMap[item] }}
					...
					<el-form-item label="项目权限">
						<el-button
							type="primary"
							@click="changeProjectPermission(addUserForm, 0)"
							>修改项目权限</el-button
						>
					</el-form-item>
			...
			<el-dialog
				title="修改项目权限"
				:visible.sync="modifyPermissionDialogVisible"
				width="80%"
			...
			>
				...
				<span slot="footer" class="dialog-footer">
					...
					<el-button type="primary" @click="modifyPermissionConfirm"
						>确 定</el-button
					>
				</span>
			</el-dialog>
			...
			>
				...
				>
					...
					<el-form-item prop="projects" label="已授权项目">
						<div
							v-for="item in modifyUserForm.projects"
							:key="item"
							style="margin-right: 10px"
						>
							{{ projectsMap[item] }}
					...
					<el-form-item label="项目权限">
						<el-button
							type="primary"
							@click="changeProjectPermission(modifyUserForm, 1)"
							>修改项目权限</el-button
						>
					</el-form-item>
				...
				<span slot="footer" class="dialog-footer">
					...
					<el-button type="primary" @click="modifyUserConfirm"
						>确 定</el-button
					>
				</span>
			</el-dialog>
		...
		<el-dialog
			title="修改密码"
			:visible.sync="modifyUserPasswordDialogVisible"
		...
		>
			...
			<span slot="footer" class="dialog-footer">
				...
				<el-button type="primary" @click="modifyUserPasswordConfirm"
					>确 定</el-button
				>
			</span>
		</el-dialog>
